    ...
    <div className="w-full h-[80px]">
      <div className="flex  justify-between items-center w-full h-full px-8 sm:mb-6">
        <div className="flex">
          ...
          <ul className="hidden md:flex items-center lg:ml-[248px]">
            <li>
        ...
        <div className="hidden md:flex">
          ...
          {!isAuthenticated && (
            <NavLink to="/login">
              <motion.button className="border-primary border-4 text-primary font-bold px-4 py-2 ml-2 rounded-md shadow-lg"
          ...
          {isAuthenticated && (
            <motion.button
              onClick={logoutUser}
              className="border-primary border-4 text-primary font-medium px-4 py-2 ml-2 rounded-md shadow-lg"
              variants={buttonVariants}
              whileHover="hover"
            >
                            Au revoir
      ...
      >
        ...
        <div className="flex flex-col items-center m-4 space-y-4">
          ...
          {isAuthenticated && (
            <button
              onClick={logoutUser}
              className="border-primary border-4 text-primary font-medium px-9 py-2 ml-2 rounded-full shadow-lg"
            >
              Au revoir
            </button>
          )}
