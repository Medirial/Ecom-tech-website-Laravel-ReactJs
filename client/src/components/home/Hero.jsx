...
const Hero = () => {
    ...
    return (
        <div>
            <div className="absolute top-[7%] -left-8 w-40 h-24 xl:w-64 xl:h-50 bg-blue-200 rounded-2xl transform-gpu -rotate-12 z-[-1]"></div>
            <div className='w-full h-screen flex flex-col justify-between px-8 py-12 z-10'>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="flex flex-col mt-16">
                        <motion.h1 className="text-3xl md:text-4xl lg-text-6xl 2xl:text-7xl font-bold"
                        ...
                        >
                            ...
                            Aux Meilleurs Prix
                            <svg
                                className="svg-underline stroke-[#000000] relative z-10 w-64 md:w-1/2 lg:w-3/4"
                        ...
                        >
                            <Link to='/products'>
                                <motion.button className="px-4 py-2 font-medium bg-white border-4 border-primary rounded-lg shadow-md"
                    ...
                    >
                        <img className="h-76" width={500} src={HeroIMG} alt="" />
                    </motion.div>
                </div>
            </div>
        </div>
